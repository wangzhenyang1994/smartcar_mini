...
class camera:
    def __init__(self, device, width, height, rates):
        ...
        self.camMat = np.array([[ 700.9994359,0,623.22280831], [0.,698.56813824,345.23773648], [0.,0.,1.]])
        self.camDistortion = np.array([[-0.32839342,0.1374803,-0.00050684,0.00093653,-0.03155774]])
